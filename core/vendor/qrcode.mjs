// Generatore di QR Code, incluso nel repo (non è una dipendenza installata).
// Origine: pacchetto npm "qrcode-generator" di Kazuhiko Arase, licenza MIT
// (http://www.opensource.org/licenses/mit-license.php). Copiato senza modifiche.
// Serve solo alla schermata di condivisione della configurazione, e viene
// caricato su richiesta: non entra nel percorso di avvio dell'app.
