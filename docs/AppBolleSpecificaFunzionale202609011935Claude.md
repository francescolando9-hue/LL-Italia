...
- **Colonna `DataInvio`: di tipo testo** (deciso il 03/09/2026), non *Data e ora*: il flow vi scrive `dataInvio` verbatim. Toglie a SharePoint la possibilità di reinterpretare il valore, che arrivava indietro di 7 ore pur essendo corretti sia il fuso del sito sia quello del profilo personale.
