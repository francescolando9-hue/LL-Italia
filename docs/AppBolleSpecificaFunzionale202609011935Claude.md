...
## Schermate
1. **Home / Carica bolle**: picker **Cantiere** (obbligatorio, lista configurabile — al lancio: MAR; poi le altre commesse), pulsante fotocamera/galleria multi-foto, anteprime con rimozione, riquadro di composizione della bolla con **«+ Aggiungi pagina a questa bolla»** (dalla prima foto), pulsante **Invia**.
